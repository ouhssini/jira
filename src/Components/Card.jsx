...
function Card({ image, title, price, reviews, click }) {
    return (
        <div onClick={click} className='w-[300px] bg-gray-600/10 rounded cursor-pointer hover:shadow hover:scale-105 transition-all duration-150 ease-in-out basis-80 h-[60vh] gap-2 flex flex-col items-center shadow-white p-4'>
